...
const katalog = (teks) => {
res = zeroyt7.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "andiX😈", "thumbnail": fs.readFileSync('thumbnail.jpg'), "surface": 'CATALOG' }}, {quoted:fstatus})
zeroyt7.relayWAMessage(res)}
const fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} }
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Follow My Ig @iam.andix", 'jpegThumbnail': fs.readFileSync('thumbnail.jpg')}}}
...
//━━━━━━━━━━━━━━━[ MENU ]━━━━━━━━━━━━━━━━━//
zeroyt7.setStatus(`𝐀𝐧𝐝𝐢𝐁𝐨𝐭𝐳 || Active Time : ${kyun(uptime)}`).catch((_)=>_);
...
costum(buffer, sticker, Verived, `Jangan Lupa SUBSCRIBE YT : andiXD`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa SUBSCRIBE YT : andiXD`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
ok = `𝐀𝐧𝐝𝐢𝐁𝐨𝐭𝐳 By andixD`
sendButLoc(from, lolot, ok, img, but)
break
case 'muridbot':
katalog(`Open Murid Bot By andixD
...
const btnskuy = {
contentText: `${anu}`,
footerText: `_𝐀𝐧𝐝𝐢𝐁𝐨𝐭𝐳 By andixD_`,
buttons: buttons,
headerType: 1
}
